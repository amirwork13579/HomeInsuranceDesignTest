        ...
        <section className={styles.relatedSection}>
          <div className="page-width">
            ...
            <div className={styles.relatedGrid}>
              ...
              <Link href="/our-process"><ShieldCheck aria-hidden="true" /><span><strong>Our Claims Process</strong><small>See how we manage a claim from first contact to settlement.</small></span><ArrowRight aria-hidden="true" /></Link>
            </div>
          </div>
        </section>
