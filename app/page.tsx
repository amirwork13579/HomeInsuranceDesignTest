      ...
      <main>
        ...
        <section className="coverage-section">
          <div className="page-width">
            ...
            <p className="coverage-note">Many claims also include professional cleaning, debris removal, emergency boarding, loss of rent for <a href="#services">landlords</a>, and business interruption for <a href="#services">business owners</a>.</p>
          </div>
        </section>
